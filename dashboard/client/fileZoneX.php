                                        ...
                                        <tbody id="myTable">
                                            ...
                                            ?>
                                                <tr style="height: 30px;">
                                                    ...
                                                    <td>
                                                        <?php if ($is_unlocked == 1) { ?>
                                                            <a href="../../uploads/files/admin/<?= $file_name ?>.csv" class="float-right" target="_blank" style="color:blueviolet">
                                                                <i class="fas fa-file-download"></i> Download</a>
                                                        <?php } else { ?>
                                                            <a href="purchase.php?fileID=<?= $file_name ?>" class="float-right" style="color:blueviolet">
