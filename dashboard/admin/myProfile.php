                                ...
                                <div class="col-md-12">
                                    <div class="profile-img-wrap">
                                        <form method="POST" id="changePic" enctype="multipart/form-data">
                                            <img class="inline-block" src="../../uploads/images/propic/<?= $server->adminData('client_propic') ?>" onerror="this.onerror=null;this.src='assets/img/user.jpg';" alt="user">
                                            <div class="fileupload btn">
                                                <span class="btn-text">Change</span>
                                                <input type="hidden" name="oldPic" value="<?= ($server->adminData('client_propic')) ?>" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group form-focus">
                                                        ...
                                                        <input type="text" class="form-control floating" name="client_firstname" value="<?= $server->adminData('client_firstname') ?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-focus">
                                                        <label class="focus-label">Last Name</label>
                                                        <input type="text" class="form-control floating" name="client_lastname" value="<?= $server->adminData('client_lastname') ?>" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-focus">
                                                        <label class="focus-label">Email Address</label>
                                                        <input type="text" class="form-control floating" value="<?= $server->adminData('client_email') ?>" readonly required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-focus">
                                                        <label class="focus-label">Contact No</label>
                                                        <input type="text" class="form-control floating" name="client_contact" value="<?= $server->adminData('client_contact') ?>">
                                                    </div>
